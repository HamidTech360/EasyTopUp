                    ...
                    <div className="airtimeText">
                     ...
                     <form onSubmit={(e)=>this.handleSubmit(e)}>
                         ...
                         <div className="mb-3">
                            ...
                            <select onChange={(e)=>this.handleChange(e)}  type="email" name="network" className="form-control" id="exampleInputEmail1">
                        ...
                        <div className="mb-3">
                            ...
                            <select onChange={(e)=>this.handleChange(e)}  type="email" name="plan" className="form-control" id="exampleInputEmail1">
                        ...
                        <div className="mb-3">
                            ...
                            <input onChange={(e)=>this.handleChange(e)} value={this.state.data.phone_no} type="number" name="phone_no" className="form-control" id="exampleInputPassword1"/>
                        </div>
